...
<body style="background: url(img/3.jpg) no-repeat center center fixed; 
    ...
    <div class="container">
	    <div class="row">
		    <div class="w3-container w3-padding w3-hide-small">
			   <h2>
				    <span class="w3-yellow w3-padding margin-0">E</span>
					<span class="w3-black  w3-padding margin-0">L</span>
					<span class="w3-blue   w3-padding margin-0">V</span>
					<span class="w3-pink   w3-padding margin-0">I</span>
					<span class="w3-green  w3-padding margin-0">N</span>
					<?php
				...
				<br/>
				<span class="w3-text-white" >A product of BeginnerPangadongan.elvin</span>
			</div>
			<div class="w3-container w3-padding w3-hide-large w3-hide-medium">
			   <h4>
				    <span class="w3-yellow w3-padding margin-0">A</span>
					<span class="w3-black  w3-padding margin-0">u</span>
					<span class="w3-blue   w3-padding margin-0">t</span>
					<span class="w3-pink   w3-padding margin-0">o</span>
					<span class="w3-green  w3-padding margin-0">fy</span>
					<?php
					    if(isset($_SESSION['user_name'])){
					?>
					<div class="dropdown w3-right">
				...
				<br/>
				<span class="w3-text-white">A product of BeginnerTopro.in</span>
			</div>
	    <div>
		<div class="row">
		    <div class="container" >
			...
			<?php
					...
					echo '<span class="w3-display-middle"><center><h4 class="w3-text-red">Please Login for the Further Use...</h4>
